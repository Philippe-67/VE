...
namespace VE.Data.Migrations
{
    ...
    [Migration("20230419090729_InterRepar")]
    partial class InterRepar
    {
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("VE.Models.Interventions", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VE.Models.Reparation_Intervention", b =>
                {
                    b.Property<int>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.ToTable("Reparation_Intervention");
                });

            modelBuilder.Entity("VE.Models.Reparations", b =>
                {
                    b.Property<int>("ReparationId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
            ...
            modelBuilder.Entity("VE.Models.Voitures", b =>
                {
                    b.Property<int>("VoituresId")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("int");
                    ...
                    b.Property<bool>("VoituresExists")
                        .HasColumnType("bit");
            ...
            modelBuilder.Entity("VE.Models.Reparation_Intervention", b =>
                {
                    b.HasOne("VE.Models.Interventions", "Intervention")
                        .WithMany("ReparationInterventions")
                        .HasForeignKey("InterventionId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("VE.Models.Reparations", "Reparation")
                        .WithMany("ReparationInterventions")
            ...
            modelBuilder.Entity("VE.Models.Reparations", b =>
                {
                    b.HasOne("VE.Models.Voitures", "Voiture")
